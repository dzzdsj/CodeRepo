...
if __name__ == "__main__":
    ...
    login_url = 'https://ikuuu.fyi/auth/login'
    check_url = 'https://ikuuu.fyi/user/checkin'
    info_url = 'https://ikuuu.fyi/user/profile'
    ...
    try:
        print(datetime.datetime.now(),'进行登录...')
